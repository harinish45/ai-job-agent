      ...
      <div className="flex flex-wrap gap-3">
        ...
        <label className="flex items-center gap-2 text-sm cursor-pointer">
          ...
          <select
            ...
            className="border rounded px-2 py-1 text-sm cursor-pointer hover:border-gray-400 transition-colors"
          >
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex flex-col gap-2 ml-4">
                  <button
                    ...
                    className="btn-secondary text-xs px-3 py-1.5 flex items-center justify-center gap-2 min-w-[110px]"
                    aria-label={`Analyze match for ${job.title}`}
                  >
                  ...
                  <button
                    ...
                    className="btn-primary text-xs px-3 py-1.5 flex items-center justify-center gap-2 min-w-[110px]"
