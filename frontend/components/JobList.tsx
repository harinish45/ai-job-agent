              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex flex-col gap-2 ml-4">
                  <button
                    ...
                    className="btn-secondary text-xs px-3 py-1.5 disabled:opacity-50 flex items-center justify-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="btn-primary text-xs px-3 py-1.5 disabled:opacity-50 flex items-center justify-center gap-1"
                  >
