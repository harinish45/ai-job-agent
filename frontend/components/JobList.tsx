...
import { Search, MapPin, DollarSign, Star, ExternalLink, Bot, Filter, Loader2 } from 'lucide-react';
            ...
            <div key={job.id} className="card hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                ...
                <div className="flex flex-col gap-2 ml-4">
                  ...
                  >
                    {matchMutation.isPending && matchMutation.variables === job.id ? <><Loader2 size={12} className="animate-spin" /> Analyzing...</> : 'Analyze Match'}
                  </button>
                  <button
                  ...
                  >
                    {applyMutation.isPending && applyMutation.variables === job.id ? <><Loader2 size={12} className="animate-spin" /> Saving...</> : 'Save Job'}
                  </button>
                  <a
                    href={job.apply_url}
                    target="_blank"
